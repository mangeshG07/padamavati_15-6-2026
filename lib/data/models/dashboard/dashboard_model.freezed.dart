...
mixin _$DashboardModel {
 ...
 String? get name;@JsonKey(name: 'role_id') int? get roleId;@JsonKey(name: 'branch_id') int? get branchId;@JsonKey(name: 'branch_name') String? get branchName;@JsonKey(name: 'today_overview') OverViewModel? get todayOverview;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DashboardModel&&(identical(other.name, name) || other.name == name)&&(identical(other.roleId, roleId) || other.roleId == roleId)&&(identical(other.branchId, branchId) || other.branchId == branchId)&&(identical(other.branchName, branchName) || other.branchName == branchName)&&(identical(other.todayOverview, todayOverview) || other.todayOverview == todayOverview));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,roleId,branchId,branchName,todayOverview);

@override
String toString() {
  return 'DashboardModel(name: $name, roleId: $roleId, branchId: $branchId, branchName: $branchName, todayOverview: $todayOverview)';
}
...
@useResult
$Res call({
 String? name,@JsonKey(name: 'role_id') int? roleId,@JsonKey(name: 'branch_id') int? branchId,@JsonKey(name: 'branch_name') String? branchName,@JsonKey(name: 'today_overview') OverViewModel? todayOverview
});
...
/// Create a copy of DashboardModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? roleId = freezed,Object? branchId = freezed,Object? branchName = freezed,Object? todayOverview = freezed,}) {
...
switch (_that) {
case _DashboardModel() when $default != null:
return $default(_that.name,_that.roleId,_that.branchId,_that.branchName,_that.todayOverview);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? name, @JsonKey(name: 'role_id')  int? roleId, @JsonKey(name: 'branch_id')  int? branchId, @JsonKey(name: 'branch_name')  String? branchName, @JsonKey(name: 'today_overview')  OverViewModel? todayOverview)  $default,) {final _that = this;
switch (_that) {
case _DashboardModel():
return $default(_that.name,_that.roleId,_that.branchId,_that.branchName,_that.todayOverview);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? name, @JsonKey(name: 'role_id')  int? roleId, @JsonKey(name: 'branch_id')  int? branchId, @JsonKey(name: 'branch_name')  String? branchName, @JsonKey(name: 'today_overview')  OverViewModel? todayOverview)?  $default,) {final _that = this;
switch (_that) {
case _DashboardModel() when $default != null:
return $default(_that.name,_that.roleId,_that.branchId,_that.branchName,_that.todayOverview);case _:
  return null;
...
class _DashboardModel implements DashboardModel {
  const _DashboardModel({this.name, @JsonKey(name: 'role_id') this.roleId, @JsonKey(name: 'branch_id') this.branchId, @JsonKey(name: 'branch_name') this.branchName, @JsonKey(name: 'today_overview') this.todayOverview});
...
@override $OverViewModelCopyWith<$Res>? get todayOverview;
...
/// Create a copy of DashboardModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? roleId = freezed,Object? branchId = freezed,Object? branchName = freezed,Object? todayOverview = freezed,}) {
