...
@JsonKey(name: 'user_id') int? get userId; String? get name;@JsonKey(name: 'profile_image') String? get profileImage; String? get gender;@JsonKey(name: 'mess_type') String? get messType;@JsonKey(name: 'mess_time') String? get messTime;@JsonKey(name: 'remaining_coupons') int? get remainingCoupons;@JsonKey(name: 'last_mess_day') String? get lastMessDay;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,name,profileImage,gender,messType,messTime,remainingCoupons,lastMessDay);

@override
String toString() {
  return 'QRUserDataModel(userId: $userId, name: $name, profileImage: $profileImage, gender: $gender, messType: $messType, messTime: $messTime, remainingCoupons: $remainingCoupons, lastMessDay: $lastMessDay)';
}
...
@useResult
$Res call({
@JsonKey(name: 'user_id') int? userId, String? name,@JsonKey(name: 'profile_image') String? profileImage, String? gender,@JsonKey(name: 'mess_type') String? messType,@JsonKey(name: 'mess_time') String? messTime,@JsonKey(name: 'remaining_coupons') int? remainingCoupons,@JsonKey(name: 'last_mess_day') String? lastMessDay
});
...
/// Create a copy of QRUserDataModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = freezed,Object? name = freezed,Object? profileImage = freezed,Object? gender = freezed,Object? messType = freezed,Object? messTime = freezed,Object? remainingCoupons = freezed,Object? lastMessDay = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'user_id')  int? userId,  String? name, @JsonKey(name: 'profile_image')  String? profileImage,  String? gender, @JsonKey(name: 'mess_type')  String? messType, @JsonKey(name: 'mess_time')  String? messTime, @JsonKey(name: 'remaining_coupons')  int? remainingCoupons, @JsonKey(name: 'last_mess_day')  String? lastMessDay)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QRUserDataModel() when $default != null:
return $default(_that.userId,_that.name,_that.profileImage,_that.gender,_that.messType,_that.messTime,_that.remainingCoupons,_that.lastMessDay);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'user_id')  int? userId,  String? name, @JsonKey(name: 'profile_image')  String? profileImage,  String? gender, @JsonKey(name: 'mess_type')  String? messType, @JsonKey(name: 'mess_time')  String? messTime, @JsonKey(name: 'remaining_coupons')  int? remainingCoupons, @JsonKey(name: 'last_mess_day')  String? lastMessDay)  $default,) {final _that = this;
switch (_that) {
case _QRUserDataModel():
return $default(_that.userId,_that.name,_that.profileImage,_that.gender,_that.messType,_that.messTime,_that.remainingCoupons,_that.lastMessDay);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'user_id')  int? userId,  String? name, @JsonKey(name: 'profile_image')  String? profileImage,  String? gender, @JsonKey(name: 'mess_type')  String? messType, @JsonKey(name: 'mess_time')  String? messTime, @JsonKey(name: 'remaining_coupons')  int? remainingCoupons, @JsonKey(name: 'last_mess_day')  String? lastMessDay)?  $default,) {final _that = this;
switch (_that) {
case _QRUserDataModel() when $default != null:
return $default(_that.userId,_that.name,_that.profileImage,_that.gender,_that.messType,_that.messTime,_that.remainingCoupons,_that.lastMessDay);case _:
  return null;
...
class _QRUserDataModel implements QRUserDataModel {
  const _QRUserDataModel({@JsonKey(name: 'user_id') this.userId, this.name, @JsonKey(name: 'profile_image') this.profileImage, this.gender, @JsonKey(name: 'mess_type') this.messType, @JsonKey(name: 'mess_time') this.messTime, @JsonKey(name: 'remaining_coupons') this.remainingCoupons, @JsonKey(name: 'last_mess_day') this.lastMessDay});
...
/// Create a copy of QRUserDataModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = freezed,Object? name = freezed,Object? profileImage = freezed,Object? gender = freezed,Object? messType = freezed,Object? messTime = freezed,Object? remainingCoupons = freezed,Object? lastMessDay = freezed,}) {
