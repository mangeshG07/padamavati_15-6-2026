...
class AppColors {
  ...
  static const Color textFieldBgColor = Color(0xFFE9E9E9);
  static const Color appBgColor = Color(0xFFFACC43);
  static const Color couponBgColor1 = Color(0xFFF5F6EE);
  static const Color couponBgColor2 = Color(0xFFFFD6D3);
