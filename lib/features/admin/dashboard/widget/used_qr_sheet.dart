...
class _UsedQrSheetState extends State<UsedQrSheet> {
  ...
  void initState() {
    super.initState();
    controller.usedQRList(studentId: widget.id);
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Expanded(
          //   child: GetBuilder<UsedQrController>(
          //     builder: (c) {
          //       return ListView.builder(
          //         controller: c.scrollController,
          //         itemCount: c.usedQrList.length + 1,
          //         itemBuilder: (context, index) {
          //           if (index < c.usedQrList.length) {
          //             final item = c.usedQrList[index];
          //
          //             return Container(
          //               margin: const EdgeInsets.symmetric(vertical: 6),
          //               padding: const EdgeInsets.all(12),
